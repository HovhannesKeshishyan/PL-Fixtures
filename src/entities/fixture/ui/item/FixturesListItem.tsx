...
import {AiPrediction} from "@/features/ai-prediction";

import type {Fixture, Match, Prediction, Team} from "@/shared/types";
            ...
            matches = fixture.matches.map((match: Match) => {
                ...
                return (
                    <li className={styles.opponentTeamNameWrapper}
                        ...
                        <AiPrediction match={match} onNewPredictionAction={onNewPredictionAction}/>
                    </li>
                )
            });
        } else {
