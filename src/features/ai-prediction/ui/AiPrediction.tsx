...
import {getScorePrediction} from "@/features/ai-prediction/api/getPrediction";

import type {Match, Prediction} from "@/shared/types";

import styles from "./AiPrediction.module.scss";
...
export const AiPrediction: FC<Props> = ({match, onNewPredictionAction}) => {
